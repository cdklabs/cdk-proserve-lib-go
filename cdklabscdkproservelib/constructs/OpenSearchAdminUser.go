...
func (j *jsiiProxy_OpenSearchAdminUser) Node() Node {
	var returns Node
	_jsii_.Get(
		j,
		"node",
...
// Constructor.
// Experimental.
func NewOpenSearchAdminUser(scope Construct, id *string, props *OpenSearchAdminUserProps) OpenSearchAdminUser {
	_init_.Initialize()
...
// Constructor.
// Experimental.
func NewOpenSearchAdminUser_Override(o OpenSearchAdminUser, scope Construct, id *string, props *OpenSearchAdminUserProps) {
	_init_.Initialize()
