...
func (j *jsiiProxy_FriendlyEmbrace) Node() Node {
	var returns Node
	_jsii_.Get(
		j,
		"node",
...
// environment.
// Experimental.
func NewFriendlyEmbrace(scope Construct, id *string, props *FriendlyEmbraceProps) FriendlyEmbrace {
	_init_.Initialize()
...
// environment.
// Experimental.
func NewFriendlyEmbrace_Override(f FriendlyEmbrace, scope Construct, id *string, props *FriendlyEmbraceProps) {
	_init_.Initialize()
