...
func (j *jsiiProxy_IamServerCertificate) Node() Node {
	var returns Node
	_jsii_.Get(
		j,
		"node",
...
// Experimental.
func NewIamServerCertificate(scope Construct, id *string, props *IamServerCertificateProps) IamServerCertificate {
	_init_.Initialize()
...
// Creates a new AWS IAM Server Certificate.
// Experimental.
func NewIamServerCertificate_Override(i IamServerCertificate, scope Construct, id *string, props *IamServerCertificateProps) {
	_init_.Initialize()
