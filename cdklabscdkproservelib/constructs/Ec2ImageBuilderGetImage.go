...
func (j *jsiiProxy_Ec2ImageBuilderGetImage) Node() Node {
	var returns Node
	_jsii_.Get(
		j,
		"node",
...
// Retrieves an EC2 Image Builder image build version.
// Experimental.
func NewEc2ImageBuilderGetImage(scope Construct, id *string, props *Ec2ImageBuilderGetImageProps) Ec2ImageBuilderGetImage {
	_init_.Initialize()
...
// Retrieves an EC2 Image Builder image build version.
// Experimental.
func NewEc2ImageBuilderGetImage_Override(e Ec2ImageBuilderGetImage, scope Construct, id *string, props *Ec2ImageBuilderGetImageProps) {
	_init_.Initialize()
