...
func init() {
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__Construct)
			return &j
		},
	)
	...
	_jsii_.RegisterEnum(
		...
		map[string]interface{}{
			...
			"SAN_SIFT_LINUX": Ec2ImagePipeline_Component_SAN_SIFT_LINUX,
	...
	_jsii_.RegisterStruct(
		"@cdklabs/cdk-proserve-lib.constructs.IamServerCertificate.ElementProps",
		reflect.TypeOf((*IamServerCertificate_ElementProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"@cdklabs/cdk-proserve-lib.constructs.OpenSearchAdminUser.PasswordCommonProps",
		reflect.TypeOf((*OpenSearchAdminUser_PasswordCommonProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
