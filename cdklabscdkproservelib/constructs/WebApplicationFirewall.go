...
func (j *jsiiProxy_WebApplicationFirewall) Node() Node {
	var returns Node
	_jsii_.Get(
		j,
		"node",
...
// Creates an AWS Web Application Firewall (WAF) that can be associated with resources such as an Application Load Balancer.
// Experimental.
func NewWebApplicationFirewall(scope Construct, id *string, props *WebApplicationFirewallProps) WebApplicationFirewall {
	_init_.Initialize()
...
// Creates an AWS Web Application Firewall (WAF) that can be associated with resources such as an Application Load Balancer.
// Experimental.
func NewWebApplicationFirewall_Override(w WebApplicationFirewall, scope Construct, id *string, props *WebApplicationFirewallProps) {
	_init_.Initialize()
