...
func (j *jsiiProxy_NetworkFirewall) Node() constructs.Node {
...
// Creates an AWS Network Firewall using a user-supplied Suricata rules file in a VPC.
// Experimental.
func NewNetworkFirewall(scope constructs.Construct, id *string, props *NetworkFirewallProps) NetworkFirewall {
	_init_.Initialize()
...
// Creates an AWS Network Firewall using a user-supplied Suricata rules file in a VPC.
// Experimental.
func NewNetworkFirewall_Override(n NetworkFirewall, scope constructs.Construct, id *string, props *NetworkFirewallProps) {
	_init_.Initialize()
