...
func (j *jsiiProxy_Ec2ImageBuilderStart) Node() constructs.Node {
...
// Starts an EC2 Image Builder Pipeline and optionally waits for the build to complete.
// Experimental.
func NewEc2ImageBuilderStart(scope constructs.Construct, id *string, props *Ec2ImageBuilderStartProps) Ec2ImageBuilderStart {
	_init_.Initialize()
...
// Starts an EC2 Image Builder Pipeline and optionally waits for the build to complete.
// Experimental.
func NewEc2ImageBuilderStart_Override(e Ec2ImageBuilderStart, scope constructs.Construct, id *string, props *Ec2ImageBuilderStartProps) {
	_init_.Initialize()
