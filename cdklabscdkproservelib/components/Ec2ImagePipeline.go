...
func (j *jsiiProxy_Ec2ImagePipeline) Node() constructs.Node {
...
// An EC2 Image Pipeline that can be used to build a Amazon Machine Image (AMI) automatically.
// Experimental.
func NewEc2ImagePipeline(scope constructs.Construct, id *string, props *Ec2ImagePipelineProps) Ec2ImagePipeline {
	_init_.Initialize()
...
// An EC2 Image Pipeline that can be used to build a Amazon Machine Image (AMI) automatically.
// Experimental.
func NewEc2ImagePipeline_Override(e Ec2ImagePipeline, scope constructs.Construct, id *string, props *Ec2ImagePipelineProps) {
	_init_.Initialize()
