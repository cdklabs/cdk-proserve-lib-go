...
func init() {
	...
	_jsii_.RegisterEnum(
		...
		map[string]interface{}{
			...
			"STIG_BUILD_LINUX": Ec2ImagePipeline_Component_STIG_BUILD_LINUX,
			"STIG_BUILD_WINDOWS": Ec2ImagePipeline_Component_STIG_BUILD_WINDOWS,
			...
			"WORKSPACES_IMAGE_COMPATIBILITY_CHECKER_WINDOWS": Ec2ImagePipeline_Component_WORKSPACES_IMAGE_COMPATIBILITY_CHECKER_WINDOWS,
	...
	_jsii_.RegisterEnum(
		...
		map[string]interface{}{
			...
			"ANTI_DDOS_RULE_SET": WebApplicationFirewall_AwsManagedRuleGroup_ANTI_DDOS_RULE_SET,
		},
	)
	_jsii_.RegisterStruct(
