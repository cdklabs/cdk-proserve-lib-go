...
func (j *jsiiProxy_NetworkFirewallEndpoints) Node() constructs.Node {
...
// Retrieves Network Firewall endpoints so that you can reference them in your other resources.
// Experimental.
func NewNetworkFirewallEndpoints(scope constructs.Construct, id *string, props *NetworkFirewallEndpointsProps) NetworkFirewallEndpoints {
	_init_.Initialize()
...
// Retrieves Network Firewall endpoints so that you can reference them in your other resources.
// Experimental.
func NewNetworkFirewallEndpoints_Override(n NetworkFirewallEndpoints, scope constructs.Construct, id *string, props *NetworkFirewallEndpointsProps) {
	_init_.Initialize()
